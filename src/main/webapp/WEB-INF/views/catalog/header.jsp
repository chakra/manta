...
<div class="canvas">
    ...
    <div class="row clearfix">
        ...
        <div class="cell"><div class="labelValue"><c:out value="${requestScope['storeContext'].storeId}" default="0"/></div></div>
        ...
        <div class="cell"><div class="labelValue"><c:out value="${requestScope['storeContext'].storeName}"/></div></div>
    </div>
