...
<%@ page import="com.espendwise.manta.util.RefCodeNames"%>
		...
		<div id="BOX_itemsNotOnShoppingList">
  		            <form:label path="ruleAction"><app:message code="admin.account.workflowRuleEdit.label.itemNotOnShoppingList"/><span class="colon">:</span></form:label>
					&nbsp;
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <form:checkbox tabindex="5" cssClass="checkbox" path="includeBuyerList"/><span class="label"><app:message code="admin.account.workflowRuleEdit.label.includeBuyerOG" /></span>
		</div>
