...
<%@ page import="com.espendwise.manta.util.RefCodeNames"%>
		...
		<div id="BOX_orderSku">
		   <form:hidden path="totalExp" value="<%=RefCodeNames.WORKFLOW_RULE_EXPRESSION.EQUALS%>"/>
           <form:label path="totalValue"><app:message code="admin.account.workflowRuleEdit.label.ifOrderSku"/><span class="colon">:</span></form:label>
  			&nbsp;
