...
<%@ page import="com.espendwise.manta.util.RefCodeNames"%>
		...
		<div id="BOX_shoppingControls">
  		            <form:label path="ruleAction"><app:message code="admin.account.workflowRuleEdit.label.itemHasShoppingControls"/><span class="colon">:</span></form:label>
					&nbsp;
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <form:checkbox tabindex="5" cssClass="checkbox" path="splitOrder"/><span class="label"><app:message code="admin.account.workflowRuleEdit.label.splitOrder" /></span>
		</div>
