...
<app:url var="baseUrl" value="/account/${accountWorkflowDetail.accountId}/workflow/${accountWorkflowDetail.workflowId}/${accountWorkflowDetail.workflowTypeCd}/rule/${accountWorkflowRuleDetail.workflowRuleId}"/>
		...
		<div id="BOX_categoryTotal">
             <table class="locate">
			   ...
			   <tr><td colspan ="2">	
		           <form:label path="totalExp"><app:message code="admin.account.workflowRuleEdit.label.ifCategory"/><span class="colon">:</span></form:label>
		           ...
		           <form:label path="totalExp"><app:message code="admin.account.workflowRuleEdit.label.hasOrderTotal"/><span class="colon">:</span></form:label>
