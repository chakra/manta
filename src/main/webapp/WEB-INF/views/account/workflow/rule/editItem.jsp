...
<app:url var="baseUrl" value="/account/${accountWorkflowDetail.accountId}/workflow/${accountWorkflowDetail.workflowId}/${accountWorkflowDetail.workflowTypeCd}/rule/${accountWorkflowRuleDetail.workflowRuleId}"/>
		...
		<div id="BOX_item">
             <table class="locate">
                <tr>
                	<td >		
						<jsp:include  page="../../../locateItem.jsp">
						     ...
						     <jsp:param name="filteredItemCommaNames" value="${accountWorkflowRuleDetail.filteredItemCommaSkus}" />
			    		</jsp:include>
		    		</td>
			   ...
			   <tr><td colspan ="2">	
		            <form:label path="ruleAction"><app:message code="admin.account.workflowRuleEdit.label.ifItemListedAbove"/>&nbsp;<app:message code="admin.account.workflowRuleEdit.label.then"/><span class="colon">:</span></form:label>
					&nbsp;
