...
<app:url var="baseUrl" value="/user/${userLocationFilter.userId}/location"/>
...
<c:set var="updateAction" value="$('form:#userSites').submit(); return false;"/>
...
function clearAllRadios() {
    $('form:#userSites input[name="defaultLocation"]').removeAttr("checked");
    $('#defaultLocationId').attr('checked', true);
}
...
<div class="canvas">
    ...
    <div class="search">
        ...
        <form:form id="search" modelAttribute="userLocationFilter" method="GET" action="${searchUrl}" focus="siteName">
            <div class="filter" >
                <table>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td  class="cell action" colspan="2">&nbsp;</td>
                        <td  class="cell">
                            <form:button  id="search"  tabindex="11" onclick="$('form:first').submit(); return false;"><app:message code="admin.global.button.search"/></form:button>
                        </td>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    </tbody>
        ...
        <form:form id="userSites" modelAttribute="userLocationFilterResult" method="POST" action="${updateUrl}">
            <c:if test="${userLocationFilterResult.result != null}">
                <hr/>
                <table width="100%">
                    <tr>
                        <td align="left">
                            <div class="resultCount label"><label><app:message code="admin.global.filter.label.resultCount" /><span class="colon">:</span></label>
                            <label class="value"></label>${fn:length(userLocationFilterResult.result)}</div>
                        </td>
                        <td align="right">
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <form:button onclick="clearAllRadios(); return false;"><app:message code="admin.global.button.clearDefaultLocation" /></form:button>
                        </td>
                    </tr>
                </table>
            </c:if>
                ...
                <table class="searchResult" width="100%">
                    ...
                    <tr class="row">
                        ...
                        <th class="cell cell-text cell-element" nowrap>
                            <a href="javascript:checkAll('userSites', 'sites.selectableObjects', true)"><app:message code="admin.global.filter.label.selectAll" /></a><br>
                            <a href="javascript:checkAll('userSites', 'sites.selectableObjects', false)"><app:message code="admin.global.filter.label.clearAll" /></a>
                        </th>
                        <th class="cell cell-text">
	                        <app:message code="admin.user.configuration.location.defaultLocation" />
    	                    <form:radiobutton tabindex="2" id="defaultLocationId" path="defaultLocation" cssClass="radio" focusable="true" value="" style="visibility: hidden;" />
                        </th>
                    </tr>
                    </thead>

                    <tbody class="body">
                    <c:forEach var="site" varStatus="i" items="${userLocationFilterResult.result}" >
                        <tr class="row">
                            ...
                            <td class="cell cell-element"><form:radiobutton tabindex="2" path="defaultLocation" cssClass="radio" focusable="true" value="${site.value.siteId}"/></td>
