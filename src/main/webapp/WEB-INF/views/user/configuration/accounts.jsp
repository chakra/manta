...
<app:url var="baseUrl" value="/user/${userAccountFilter.userId}/account"/>
...
<c:set var="updateAction" value="$('form:#userAccounts').submit(); return false;"/>
...
<div class="canvas">
    ...
    <div class="search">
        ...
        <form:form id="search" modelAttribute="userAccountFilter" method="GET" action="${searchUrl}" focus="accountName">
            <div class="filter" >
                <table>
                    <tbody>
                    <tr>
                                                    ...
                                                    <div class="boxContent">
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td nowrap>
                                                                        <form:checkbox tabindex="3" cssClass="checkbox"  path="associateAllAccounts"/>
                                                                        <label><app:message code="admin.user.configuration.account.associateAllAccounts" /></label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td nowrap>
                                                                        <form:checkbox tabindex="3" cssClass="checkbox"  path="associateAllSites"/>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <form:button  id="search" style="display:none;" onclick="$('form:first').submit(); return false;"><app:message code="admin.global.button.search"/></form:button>
                                                                        <form:button tabindex="4" onclick="${updateAllAction}"><app:message code="admin.global.button.save" /></form:button>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                    ...
                    <tr>
                        ...
                        <td class="cell value">
                            <form:input tabindex="3" id="accountName" path="accountName" cssClass="filterValue"/>
                        </td>
                        <td class="cell" style="padding-top: 0;">
                            <form:radiobutton tabindex="2" path="accountNameFilterType" cssClass="radio" focusable="true" value="<%=com.espendwise.manta.util.Constants.FILTER_TYPE.START_WITH%>"/><span class="label"><app:message code="admin.global.filter.label.startWith"/></span>
                            <br>
                            <form:radiobutton tabindex="2" path="accountNameFilterType" cssClass="radio" focusable="true" value="<%=com.espendwise.manta.util.Constants.FILTER_TYPE.CONTAINS%>"/><span class="label"><app:message code="admin.global.filter.label.contains"/></span>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td  class="cell">
                            <form:checkbox tabindex="3" cssClass="checkbox"  path="showConfiguredOnly"/>
                    ...
                    <tr>
                        <td  class="cell action" colspan="2">&nbsp;</td>
                        <td  class="cell">
                            <form:checkbox tabindex="3" cssClass="checkbox"  path="showInactive"/>
                    ...
                    <tr>
                        <td  class="cell action" colspan="2">&nbsp;</td>
                        <td  class="cell">
                            <form:button  tabindex="5" onclick="$('form:first').submit(); return false;"><app:message code="admin.global.button.search"/></form:button>
                        </td>
                        <td colspan="3">&nbsp;</td>
                    </tr>
                    </tbody>
        ...
        <form:form id="userAccounts" modelAttribute="userAccountFilterResult" method="POST" action="${updateUrl}">
            <c:if test="${userAccountFilterResult.result != null}">
                <hr/>
                <table width="100%">
                    <tr>
                        <td align="left">
                            <div class="resultCount label"><label><app:message code="admin.global.filter.label.resultCount" /><span class="colon">:</span></label>
                            <label class="value"></label>${fn:length(userAccountFilterResult.result)}</div>
                        </td>
                        <td align="right">
                ...
                <table class="searchResult" width="100%">
                    ...
                    <tr class="row">
                        ...
                        <th class="cell cell-text cell-element" nowrap>
                            <a href="javascript:checkAll('userAccounts', 'accounts.selectableObjects', true)"><app:message code="admin.global.filter.label.selectAll" /></a><br>
                            <a href="javascript:checkAll('userAccounts', 'accounts.selectableObjects', false)"><app:message code="admin.global.filter.label.clearAll" /></a>
                        </th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody class="body">
                    <c:forEach var="account" varStatus="i" items="${userAccountFilterResult.result}" >
                        <tr class="row">
