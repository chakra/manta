...
public class OrderGuideItemListViewCriteria implements Serializable {
    ...
    public OrderGuideItemListViewCriteria(Long storeId, Integer limit) {
        this.storeId = storeId;
        this.limit = limit;
    }

    public OrderGuideItemListViewCriteria(Integer limit) {
        this.limit = limit;
    }
    public OrderGuideItemListViewCriteria() {
