...
public class LongValidator implements CustomValidator<String, ValidationCodeResolver> {
    ...
    public Long parse(String value) throws AppParserException {
    ...
    private void setParsedValue(Long parsedValue) {
