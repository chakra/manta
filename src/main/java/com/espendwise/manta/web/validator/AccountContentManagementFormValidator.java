...
public class AccountContentManagementFormValidator extends AbstractFormValidator{
	
	private static final Logger logger = Logger.getLogger(AccountContentManagementFormValidator.class);

    public AccountContentManagementFormValidator() {
        super();
    }
    ...
    public ValidationResult validate(Object obj) {
    	...
    	AccountContentManagementForm valueObj = (AccountContentManagementForm) obj;
