...
public class LocateItemOrderGuideFilterFormValidator extends AbstractFormValidator {

    @Override
    public ValidationResult validate(Object obj) {

        LocateItemOrderGuideFilterForm form = (LocateItemOrderGuideFilterForm) obj;
