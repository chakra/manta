...
public class CorporateScheduleLocationFilterFormValidator extends AbstractFormValidator {

    @Override
    public ValidationResult validate(Object obj) {

        CorporateScheduleLocationFilterForm form = (CorporateScheduleLocationFilterForm) obj;
