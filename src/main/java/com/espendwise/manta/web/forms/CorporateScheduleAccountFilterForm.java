...
import com.espendwise.manta.web.validator.CorporateScheduleAccountFilterFormValidator;


@Validation(CorporateScheduleAccountFilterFormValidator.class)
public class CorporateScheduleAccountFilterForm extends WebForm implements Resetable, Initializable {
    ...
    public CorporateScheduleAccountFilterForm() {
        super();
    }

    public CorporateScheduleAccountFilterForm(Long scheduleId) {
        super();
