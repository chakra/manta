...
import com.espendwise.manta.web.validator.CorporateScheduleLocationFilterFormValidator;


@Validation(CorporateScheduleLocationFilterFormValidator.class)
public class CorporateScheduleLocationFilterForm extends WebForm implements Resetable, Initializable {
    ...
    public CorporateScheduleLocationFilterForm() {
        super();
    }

    public CorporateScheduleLocationFilterForm(Long scheduleId) {
        super();
