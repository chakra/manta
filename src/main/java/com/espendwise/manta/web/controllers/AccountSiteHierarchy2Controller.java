...
@Controller
@RequestMapping(UrlPathKey.ACCOUNT.SITE_HIERARCHY_LEVEL_2)
public class AccountSiteHierarchy2Controller extends SiteHierarchyBaseController {

    private static final Logger logger = Logger.getLogger(AccountSiteHierarchy2Controller.class);

    @Autowired
    public AccountSiteHierarchy2Controller(AccountService accountService, SiteHierarchyService siteHierarchyService, SiteService siteService) {
